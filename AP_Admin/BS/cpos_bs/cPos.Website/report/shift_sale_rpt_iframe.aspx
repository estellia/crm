<%@ Page Title="" Language="C#" MasterPageFile="~/common/Site.master" AutoEventWireup="true" CodeFile="shift_sale_rpt_iframe.aspx.cs" Inherits="report_shift_sale_rpt_iframe" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" Runat="Server">
    ...
    function resetTotalCount(obj, amount) {
        obj.innerText = parseInt(obj.innerText) - parseInt(amount);
    ...
    function downloadExcel() {
        var that = this;
        var condition = { type: "shiftDetail"};
        $.ajax({
...
total += item.total_amount;
           ...
           <uc1:SplitPageControl runat="server" ID="SplitPageControl1" PageSize="10" CssClass=" pag" OnRequireUpdate="SplitPageControl_OnRequireUpdate"/>
        </div>
    </div>
