<%@ Page Title="" Language="C#" MasterPageFile="~/common/Site.master" AutoEventWireup="true" CodeFile="inout_bill_in_show_item.aspx.cs" Inherits="inout_bill_in_show_item" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" Runat="Server">
    <style type="text/css">
        ...
        .llinput{ background:url(../img/butt01.png) no-repeat; width:65px; height:26px; color:#0e6099; font-weight:bold; border:0px; margin-right:10px;}
    </style>
    <script type="text/javascript">
        function confirm() {
            ...
            if (checkInput()) {
                ...
                value.retail_price = $("#<%=retail_price.ClientID %>").val();
    ...
    <script type="text/javascript">
        function checkInput() {
            ...
            var value = $("#sku_id")[0].item;
            if (!value) {
                this.infobox.showPop("必须选择商品");
                $("#<%=selSku.ClientID %>").focus();
                return false;
            }
            if ($("#<%=tbOrderQty.ClientID %>").val() == "") {
                $("#<%=tbOrderQty.ClientID %>").focus();
                this.infobox.showPop("预订数不能为空");
                return false;
            }
            ...
            if ($("#<%=std_price.ClientID %>").val() == "") {
                $("#<%=std_price.ClientID %>").focus();
                this.infobox.showPop("建议零售价不能为空");
                return false;
            }
            if (!pirce.test($("#<%=std_price.ClientID %>").val())) {
                $("#<%=std_price.ClientID %>").focus();
                alert("建议零售价格式不正确");
                return false;
            }
            if ($("#<%=retail_price.ClientID %>").val() == "") {
                $("#<%=retail_price.ClientID %>").focus();
                this.infobox.showPop("采购价不能为空");
                return false;
            }
            if (!pirce.test($("#<%=retail_price.ClientID %>").val())) {
                $("#<%=retail_price.ClientID %>").focus();
                alert("采购价格式不正确");
                return false;
            }
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    <div class="ss_bg" style="background:rgb(242, 241, 239);">
        <table cellpadding="0" cellspacing="0" class="con_tab" border="0" style="margin-left:auto; margin-right:auto">
            <tr >
                <td  class="td_co">
                    商品查询：
                </td>
            ...
            <tr>
                ...
                <td>
                    ...
                    <asp:TextBox ID="tbItemName" ReadOnly="true" runat="server" Width="150px" CssClass="fl ban_in_oper_time"
                ...
                <td>
                    ...
                    <asp:TextBox ID="tbItemCode" ReadOnly="true" runat="server" Width="150px" CssClass="fl ban_in_oper_time"
           ...
           <tr class="<%=this.SkuPropInfos.FirstOrDefault(obj=>obj.display_index==1)==null&&this.SkuPropInfos.FirstOrDefault(obj=>obj.display_index==2)==null?"hidden":"" %>">
            ...
            <tr>
                ...
                <td>
                    ...
                    <asp:TextBox ID="tbOrderQty" Width="150px" runat="server" 
                ...
                <td>
                    ...
                    <asp:TextBox ID="tbEnterQty" Width="150px" runat="server" 
                        MaxLength="15"></asp:TextBox>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    ...
                    <asp:TextBox ID="std_price" Width="150px" runat="server" 
                        MaxLength="15"></asp:TextBox>
                </td>
                <td class="td_co" >
                    采购价： 
                ...
                <td>
                    ...
                    <asp:TextBox ID="retail_price" Width="150px" runat="server" 
                        MaxLength="15"></asp:TextBox>
                </td>
            </tr>
        </table>
