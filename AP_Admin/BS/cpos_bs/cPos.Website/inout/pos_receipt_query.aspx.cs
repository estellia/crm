...
public partial class inout_pos_receipt_query : PageBase
{
    ...
    protected cPos.Service.PosInoutService PosInoutService
    {
        get
        {
            return new cPos.Service.PosInoutService();
        }
    }
    ...
    private void Query(int index)
    {
        try
        {
            ...
            var source = this.PosInoutService.SearchPosInfo(loggingSessionInfo, qc.order_no, qc.unit_id, qc.item_name, qc.order_date_begin, qc.order_date_end, this.SplitPageControl1.PageSize, this.SplitPageControl1.PageSize * index);
    ...
    protected override void OnPreRender(EventArgs e)
    {
        ...
        sb.Append("&unit_id=" + Server.UrlEncode(this.selUnit.SelectedValue));
