...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="Server">
    <script type="text/javascript">
        ...
        function downloadExcel() {
            var condition = { type: "pos", order_no: $("#<%=tbOrderNo.ClientID %>").val(), item_name: $("#<%=tbItem.ClientID %>").val(), order_date_begin: $("#<%=selDateStart.ClientID %>").val(), order_date_end: $("#<%=selDateEnd.ClientID %>").val(), unit_id: $("#<%=selUnit.ClientID %>")[0].values()[0] };
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <table border="0" cellspacing="0" cellpadding="0" class="ss_tj">
        <tr>
            ...
            <td class="td_lp" colspan="3">
                <uc1:DropDownTree ID="selUnit" runat="server" MultiSelect="false"  Url="../ajaxhandler/tree_query.ashx?action=unit" />
            </td>
        </tr>
        <tr>
            <td class="tit_c">
    ...
    <div class="b_bg">
        ...
        <input type="button" runat="server" id="btnReset" value="重置" onserverclick="btnResetClick"
            class="input_c" />
        <input type="button" class="input_c" value="导出" onclick="downloadExcel();" id="btnDownLoad" />
    </div>
    <div class="tit_con">
        <span>搜索结果</span>
    </div>
        ...
        <asp:GridView ID="gvPos" runat="server" CellPadding="0" Width="100%" GridLines="None"
            ...
            <Columns>
                ...
                <asp:BoundField ItemStyle-Width="100px" DataField="sales_user" HeaderText="业务员"
                    ItemStyle-HorizontalAlign="Center"  />    
                    <%--
                <asp:BoundField ItemStyle-Width="100px" DataField="send_user_name" HeaderText="发出人"
                    ItemStyle-HorizontalAlign="Center" />
                <asp:BoundField ItemStyle-Width="100px" DataField="send_time" HeaderText="发出日期" ItemStyle-HorizontalAlign="Center" />
                <asp:BoundField ItemStyle-Width="100px" DataField="approve_user_name" HeaderText="验收人"
                    ItemStyle-HorizontalAlign="Center" />
                <asp:BoundField ItemStyle-Width="100px" DataField="approve_time" HeaderText="验收日期"
                    ItemStyle-HorizontalAlign="Center" />--%>
