...
#region 服务
    ...
    private void Query(int index)
    {
        try
        {
            ...
            var source = this.ItemService.SearchItemList(loggingSessionInfo, qs.ItemCode, qs.ItemName, qs.ItemCategoryID, qs.ItemStatus ?? "", this.SplitPageControl1.PageSize, this.SplitPageControl1.PageSize * index);
