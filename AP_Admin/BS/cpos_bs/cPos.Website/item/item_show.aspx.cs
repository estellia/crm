...
public partial class item_item_show : PageBase
{
    ...
    #region 服务
    protected cPos.Service.ItemService ItemService
    {
        get
        {
            return new cPos.Service.ItemService();
        }
    }
    protected cPos.Service.ItemCategoryService ItemCategoryService
    {
        get
        {
            return new cPos.Service.ItemCategoryService();  
        }
    }
    protected cPos.Service.ItemPropService ItemPropService
    {
        get
        {
            return new cPos.Service.ItemPropService();
        }
    }
    ...
    private void LoadItemInfoData()
    {
        try
        {
            ...
            this.ddIsGB.SelectedValue = source.isGB.ToString();
            this.tbDisplayIndex.Text = source.display_index.ToString() ?? "";
    ...
    private void LoadItemType()
    {
        try
        {
            ...
            this.selItemCategory.DataBind<cPos.Model.ItemCategoryInfo>(source, obj => origin_source.Where(o => o.Parent_Id == obj.Item_Category_Id), obj => new controls_DropDownTree.tvNode
                {
                    ShowCheck = false,
                    Complete = true,
    ...
    private cPos.Model.ItemInfo GetNewItemInfo()
    {
        ...
        itemInfo.isGB = int.Parse(this.ddIsGB.SelectedValue);
        itemInfo.data_from = "3";
        itemInfo.display_index = int.Parse(tbDisplayIndex.Text);
