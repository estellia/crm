...
namespace cPos.Service
{
    ...
    public class cBillService : BaseService
    {
        ...
        public IList<BillKindModel> GetAllBillKinds(LoggingSessionInfo loggingSession)
        {
            ...
            return cSqlMapper.Instance(loggingSession.CurrentLoggingManager).QueryForList<BillKindModel>("BillKind.Select", hashTable);
        }
        ...
        public BillKindModel GetBillKindById(LoggingSessionInfo loggingSession, string billKindId)
        {
            ...
            return cSqlMapper.Instance(loggingSession.CurrentLoggingManager).QueryForObject<BillKindModel>("BillKind.SelectById", hashTable);
        }
        ...
        public BillKindModel GetBillKindByCode(LoggingSessionInfo loggingSession, string billKindCode)
        {
            ...
            return cSqlMapper.Instance(loggingSession.CurrentLoggingManager).QueryForObject<BillKindModel>("BillKind.SelectByCode", hashTable);
        }
        #endregion
        ...
        private BillStatusModel GetBillBeginStatus(LoggingSessionInfo loggingSession, string billKindId)
        {
            ...
            return cSqlMapper.Instance(loggingSession.CurrentLoggingManager).QueryForObject<BillStatusModel>("BillStatus.GetBeginStatusByKindId", hashTable);
        }
        ...
        public BillStatusModel GetBillStatusByKindIdAndStatus(LoggingSessionInfo loggingSession, string billKindId, string billStatus)
        {
            ...
            hashTable.Add("CustomerId", loggingSession.CurrentLoggingManager.Customer_Id);
            return cSqlMapper.Instance(loggingSession.CurrentLoggingManager).QueryForObject<BillStatusModel>("BillStatus.SelectByKindIdAndStatus", hashTable);
        }
        ...
        private BillStatusModel GetBillDeleteStatus(LoggingSessionInfo loggingSession, string billKindId)
        {
            ...
            hashTable.Add("BillKindId", billKindId);
            hashTable.Add("CustomerId", loggingSession.CurrentLoggingManager.Customer_Id);
            return cSqlMapper.Instance().QueryForObject<BillStatusModel>("BillStatus.GetDeleteStatusByKindId", hashTable);
        }
        ...
        public IList<BillStatusModel> GetBillStatusByKindCode(LoggingSessionInfo loggingSession, string bill_kind_code)
        {
            ...
            hashTable.Add("CustomerId", loggingSession.CurrentLoggingManager.Customer_Id);
            return cSqlMapper.Instance().QueryForList<BillStatusModel>("BillStatus.SelectByKindCode", hashTable);
        }
        ...
        public IList<BillStatusModel> GetAllBillStatusesByBillKindID(LoggingSessionInfo loggingSession, string billKindID)
        {
            ...
            hashTable.Add("BillKindId", billKindID);
            hashTable.Add("CustomerId", loggingSession.CurrentLoggingManager.Customer_Id);
            return cSqlMapper.Instance().QueryForList<BillStatusModel>("BillStatus.SelectByKindId", hashTable);
        }
        ...
        public bool CanDeleteBillStatus(LoggingSessionInfo loggingSession, string billStatusID)
        {
            ...
            int ret = cSqlMapper.Instance(loggingSession.CurrentLoggingManager).QueryForObject<int>("BillStatus.CountUsingBillsById", billStatusID);
            if (ret > 0)
                return false;

            //检查是否存在角色与表单操作的关系中的前置状态或者当前状态=要删除的表单状态
            ret = cSqlMapper.Instance(loggingSession.CurrentLoggingManager).QueryForObject<int>("BillStatus.CountUsingBillActionRolesById", billStatusID);
            return ret == 0;
        }
        ...
        {
            int ret = cSqlMapper.Instance(loggingSession.CurrentLoggingManager).Delete("BillStatus.DeleteById", billStatusID);
            return ret == 1;
        }
        ...
        public IList<BillActionModel> GetAllBillActionsByBillKindId(LoggingSessionInfo loggingSession, string billKindID)
        {
            ...
            ht.Add("CustomerId",loggingSession.CurrentLoggingManager.Customer_Id);
            return cSqlMapper.Instance(loggingSession.CurrentLoggingManager).QueryForList<BillActionModel>("BillAction.SelectByKindId", ht);
        }
        /// <summary>
        /// 获取表单动作
        /// </summary>
        ...
        public BillActionInfo GetBillActionByBillId(LoggingSessionInfo loggingSessionInfo, string billId)
        {
            ...
            return (BillActionInfo)cSqlMapper.Instance().QueryForObject("BillActionInfo.GetBillActionByBillId", _ht);
        }
        ...
        {
            int ret = cSqlMapper.Instance().QueryForObject<int>("BillAction.CountUsingBillAction", billActionID);
            return ret == 0;
        }
        ...
        {
            int ret = cSqlMapper.Instance(loggingSession.CurrentLoggingManager).Delete("BillAction.DeleteByID", billActionID);
            return ret == 1;
        }
        #endregion
        ...
        public BillModel GetBillById(LoggingSessionInfo loggingSession, string billId)
        {
            ...
            return cSqlMapper.Instance(loggingSession.CurrentLoggingManager).QueryForObject<BillModel>("Bill.SelectById", hashTable);
        }
        ...
        public bool CanCreateBill(LoggingSessionInfo loggingSession, string unitRelationModeId, string billKindId)
        {
            ...
            int count = cSqlMapper.Instance().QueryForObject<int>("BillActionRole.CountCreateActionRoleByKindIdAndRoleId", hashTable);
            return count > 0;
        }
        ...
        public bool CanCreateBillKind(LoggingSessionInfo loggingSession, string billKindCode)
        {
            ...
            int count = cSqlMapper.Instance().QueryForObject<int>("BillActionRole.CountCreateActionRoleByKindCodeAndRoleId", hashTable);
            return count > 0;
        }
        /// <summary>
        /// 根据标识判断Bill是否存在
        ...
        public bool CanHaveBill(LoggingSessionInfo loggingSessionInfo, string billId,out string strError)
        {
            ...
            int count = cSqlMapper.Instance(loggingSessionInfo.CurrentLoggingManager).QueryForObject<int>("Bill.CanHaveBill", _ht);
        ...
        public bool CanApproveBill(LoggingSessionInfo loggingSessionInfo, string unitRelationModeId, string billId)
        {
            ...
            int count = cSqlMapper.Instance(loggingSessionInfo.CurrentLoggingManager).QueryForObject<int>("Bill.CountApproveBill", hashTable);
            return count > 0;
        }
        #endregion 
        ...
        {
            return cSqlMapper.Instance().QueryForList<SelectBillActionRoleInfo>("BillActionRole.SelectByCondition", condition);
        }
        ...
        public bool DeleteBillActionRole(LoggingSessionInfo loggingSession, string billActionRoleID)
        {
            ...
            {
                cSqlMapper.Instance().BeginTransaction();
                int ret = cSqlMapper.Instance().Delete("BillActionRole.Delete", billActionRoleID);
                if (ret != 1)
                {
                    cSqlMapper.Instance().RollBackTransaction();
                    return false;
        ...
        /// <returns></returns>
        public bool SetBatBillActionRole(Hashtable _ht)
        {
            cSqlMapper.Instance().Insert("Bill.InsertBatBillActionRole", _ht);
            return true;
        }
        public bool SetBatBillActionRole(Hashtable _ht,LoggingManager loggingManager)
        {
            cSqlMapper.Instance(loggingManager).Insert("Bill.InsertBatBillActionRole", _ht);
            return true;
        }
        #endregion
