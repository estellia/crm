    ...
    public class AdjustmentOrderService:BaseService
    {
                                                                            ...
                                                                            , int startRowIndex)
        {
            try
            {
                ...
                int iCount = cSqlMapper.Instance().QueryForObject<int>("AdjustmentOrder.SearchCount", _ht);

                IList<AdjustmentOrderInfo> adjustmentOrderInfoList = new List<AdjustmentOrderInfo>();
                adjustmentOrderInfoList = cSqlMapper.Instance().QueryForList<AdjustmentOrderInfo>("AdjustmentOrder.Search", _ht);
                ...
                //return cSqlMapper.Instance().QueryForList<AdjustmentOrderInfo>("AdjustmentOrder.Search", _ht);
            }
            catch (Exception ex) {
                throw (ex);
            }
        ...
        public AdjustmentOrderInfo GetAdjustmentOrderByOrderId(LoggingSessionInfo loggingSessionInfo, string orderId)
        {
            try
            {
                ...
                AdjustmentOrderInfo adjustmentOrderInfo = new AdjustmentOrderInfo();
                adjustmentOrderInfo = (AdjustmentOrderInfo)cSqlMapper.Instance().QueryForObject("AdjustmentOrder.SelectById", _ht);
        ...
        public bool IsExistOrderCode(LoggingSessionInfo loggingSessionInfo, string order_no, string order_id)
        {
            try
            {
                ...
                int n = cSqlMapper.Instance(loggingSessionInfo.CurrentLoggingManager).QueryForObject<int>("AdjustmentOrder.IsExsitOrderCode", _ht);
        ...
        private bool SetAdjustmentOrderTableInfo(LoggingSessionInfo loggingSessionInfo, AdjustmentOrderInfo adjustmentOrderInfo)
        {
            try
            {
                if (adjustmentOrderInfo != null)
                {
                    ...
                    cSqlMapper.Instance(loggingSessionInfo.CurrentLoggingManager).Update("AdjustmentOrder.InsertOrUpdate", adjustmentOrderInfo);
                }
                return true;
            }
            catch (Exception ex)
        ...
        public int GetAdjustmentOrderNotPackagedCount(LoggingSessionInfo loggingSessionInfo, string unit_id, int no, string item_price_type_id)
        {
            ...
            _ht.Add("No", no);
            _ht.Add("ItemPriceTypeId", item_price_type_id);
            return cSqlMapper.Instance(loggingSessionInfo.CurrentLoggingManager).QueryForObject<int>("AdjustmentOrder.SelectUnDownloadCount", _ht);
        }
                                                                        ...
                                                                        )
        {
            ...
            _ht.Add("StartRow", startRowIndex);
            _ht.Add("EndRow", startRowIndex + maxRowCount);
            adjustmentOrderList = cSqlMapper.Instance(loggingSessionInfo.CurrentLoggingManager).QueryForList<AdjustmentOrderInfo>("AdjustmentOrder.SelectUnDownload", _ht);
