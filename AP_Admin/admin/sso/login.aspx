...
<body>
    <form id="form1" runat="server">
        ...
        <div class="login">
	<div class="login_nr">
    	<div class="logo"><img src="images/logo.png" width="102" height="126" /></div>
        <div style=" font-weight:100; text-align:left;  color:red;">
	            <b><asp:Label ID="lblInfor" runat="server" style="color:red"></asp:Label></b>
	        </div>
      <div class="login_dl">
        	<ul>
            	<li><span>商户代码</span>     <input type="text" runat="server" class="LoginText" value="" runat="server" id="txtCustomerCode" placeholder="输入公司编码"  /></li>
            	<li><span>用户名</span><input type="text" runat="server" class="LoginText" value="" id="txtUsername" runat="server"   placeholder="用户名"/></li>
            	<li><span>密码</span> <input type="password" runat="server" class="LoginText" id="txtPassword" runat="server" placeholder="密码" /></li>
                <li class="rememberPass"  runat="server" ><em></em>记住密码
                    
                    <input type="checkbox" id="chkRemember" runat="server" style="filter:alpha(opacity=0);opacity:0;display:none"  /> </li>
            </ul>
            <div class="denglu">  
                <asp:LinkButton id="btnLogin" runat="server" class="loginBtn" OnClick="btnLogin_Click"  >登录</asp:LinkButton>
            </div>
            <div class="guanzhu">
            	<dl> 
                	<dt>下载连锁掌柜APP<span></span></dt>
                    <dd>关注连锁掌柜公众号<span></span></dd>
                </dl>
          </div>
      </div>
    </div>
...
<script type="text/javascript">
    ...
    document.write(unescape("%3Cscript src='" + _bdhmProtocol + "hm.baidu.com/h.js%3F7567549df6f7e642f6d61bab3dd7eac7' type='text/javascript'%3E%3C/script%3E"));
</script>
</div>
</body>
</html>
