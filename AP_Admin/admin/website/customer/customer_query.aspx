<%@ Page Title="客户查询" Language="C#" MasterPageFile="~/common/Site.master" AutoEventWireup="true"
    CodeFile="customer_query.aspx.cs" Inherits="customer_customer_query" %>
            ...
            <Columns>
                ...
                <asp:TemplateField ItemStyle-Width="150px" HeaderText="操作" ItemStyle-CssClass="gv-5icon">
                    <ItemTemplate>
                        ...
                        <a href='http://dev.o2omarketing.cn:9004/External/PageConfig/applyToCustomer.aspx?customerId=<%# Eval("ID")%>' target="_blank">
