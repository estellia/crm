...
public partial class item_item_price_adjust_show : PageBase
{
    ...
    protected cPos.Admin.Service.AdjustmentOrderService AdjustmentOrderService
    {
        get
        {
            return new cPos.Admin.Service.AdjustmentOrderService();
        }
    }
    ...
    private void InitOrderNo()
    {
        try
        {
            var service = new cPos.Admin.Service.BillService();
    ...
    private AdjustmentOrderInfo GetNewAdjustOrderInfo()
    {
        ...
        {
            adjustmentOrderInfo.create_time = new cPos.Admin.Service.BaseService().GetCurrentDateTime();
        ...
        else
        {
            ...
            adjustmentOrderInfo.modify_time = new cPos.Admin.Service.BaseService().GetCurrentDateTime();
