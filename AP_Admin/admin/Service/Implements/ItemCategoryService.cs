...
namespace cPos.Admin.Service
{
    ...
    public class ItemCategoryService:BaseService
    {
        ...
        public IList<ItemCategoryInfo> GetItemCagegoryList(LoggingSessionInfo loggingSessionInfo)
        {
            try
            {
                return MSSqlMapper.Instance().QueryForList<ItemCategoryInfo>("ItemCategory.SelectAll", "");
            }
            catch (Exception ex) {
                throw (ex);
            }
        ...
        public ItemCategoryInfo GetItemCategoryById(LoggingSessionInfo loggingSessionInfo, string Item_Category_Id)
        {
            try
            {
                ...
                return (ItemCategoryInfo)MSSqlMapper.Instance(loggingSessionInfo.CurrentLoggingManager).QueryForObject("ItemCategory.SelectById", _ht);
            }
            catch (Exception ex)
            {
                throw (ex);
        ...
        public bool IsExistItemCategoryCode(LoggingSessionInfo loggingSessionInfo, string item_category_code,string item_category_id)
        {
            try
            {
                ...
                _ht.Add("Item_Category_Code", item_category_code);
                _ht.Add("Item_Category_Id", item_category_id);
                int n = MSSqlMapper.Instance(loggingSessionInfo.CurrentLoggingManager).QueryForObject<int>("ItemCategory.IsExsitItemCategoryCode", _ht);
        ...
        {
            return MSSqlMapper.Instance(loggingSessionInfo.CurrentLoggingManager).QueryForList<ItemCategoryInfo>("ItemCategory.SelectUnDownload", "");
        }
        ...
        public bool SetItemCategoryBatInfo(LoggingSessionInfo loggingSessionInfo, string bat_id, IList<ItemCategoryInfo> ItemCategoryInfoList)
        {
            ...
            itemCategoryInfo.ItemCategoryInfoList = ItemCategoryInfoList;
            MSSqlMapper.Instance(loggingSessionInfo.CurrentLoggingManager).Update("ItemCategory.UpdateUnDownloadBatId", itemCategoryInfo);
            return true;
