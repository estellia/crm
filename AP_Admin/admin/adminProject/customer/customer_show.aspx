<%@ Page Title="" Language="C#" MasterPageFile="~/common/Site.master" AutoEventWireup="true"
    Inherits="customer_customer_show" CodeBehind="customer_show.aspx.cs" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    <cc1:TabContainer ID="tabContainerCustomer" runat="server">
                    ...
                    <table border="0" cellspacing="0" cellpadding="0" class="con_tab">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <asp:TextBox ID="tbUnits" runat="server" MaxLength="100"  Text="不限制"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td class="td_co">
                ...
                <div style="background-color: #f2f1ef;" class="ss_bg">
                    ...
                    <div style="height: 400px; padding: 0px;">
                        ...
                        <asp:GridView ID="gvCustomer" runat="server" CellPadding="0" CellSpacing="1" CssClass="ss_jg"
                            AutoGenerateColumns="False" DataSourceID="odsCustomer" AllowPaging="True" DataKeyNames="DataDeployId"
                            OnRowDataBound="gvCustomer_RowDataBound" OnRowCommand="gvCustomer_RowCommand"
        ...
        <cc1:TabPanel ID="tabUnit" runat="server" CssClass="tab_panel">
            <HeaderTemplate>
                <div class="tab_head">
                    <span style="font-size: 12px;" id="Unit_info">运营商信息</span></div>
            </HeaderTemplate>
            <ContentTemplate>
          <div style="background-color: #f2f1ef;" class="ss_bg">
                    <div style="height: 400px; padding: 0px;">
                        ...
                        <asp:GridView ID="gvUnit" runat="server" CellPadding="0" CellSpacing="1" CssClass="ss_jg"
                            AutoGenerateColumns="False" DataSourceID="odsUnit" AllowPaging="True" DataKeyNames="Id"
                            OnRowDataBound="gvUnit_RowDataBound" OnRowCommand="gvUnit_RowCommand" GridLines="None"
                            ShowHeaderWhenEmpty="True">
                            <RowStyle CssClass="b_c4" />
                            <Columns>
                                <asp:TemplateField ItemStyle-CssClass="gv-checkbox" HeaderText="">
                                    <ItemTemplate>
                                        <asp:CheckBox ID="select" CssClass="select" onclick="check()" runat="server" UnitId='<%#Eval("Id") %>' />
                                    </ItemTemplate>
                                    <ItemStyle HorizontalAlign="Center" />
                                </asp:TemplateField>
                                <asp:BoundField DataField="code" HeaderText="运营商编码" />
                                <asp:BoundField DataField="name" HeaderText="运营商名称" />
                                <%--  <asp:BoundField DataField="DataDeployDesc" HeaderText="描述" />--%>
                            </Columns>
                            <PagerTemplate>
                                <uc1:Pager ID="Pager1" runat="server" RecordCount="0" />
                        ...
                        <div class="b_bg" style="display: none;">
                            ...
                            <asp:Button ID="Button1" CssClass="input_c" Text="选择" runat="server" OnClick="btnQuery_Click" />
                        </div>
                        <asp:ObjectDataSource ID="odsUnit" runat="server" EnablePaging="True" MaximumRowsParameterName="maxRowCount"
                            OnObjectCreating="odsUnit_ObjectCreating" OnSelecting="odsUnit_Selecting" SelectCountMethod="GetUnitInfoListCount"
                            SelectMethod="GetUnitInfoList" StartRowIndexParameterName="startRowIndex" TypeName="cPos.Admin.Service.Interfaces.IUnitService">
                        </asp:ObjectDataSource>
                    </div>
                </div>
            </ContentTemplate>
