...
return false;
}},{title:"",width:250,height:100,showType:"slide",showSpeed:600,msg:"",timeout:2000},_295);
...
}else if(box.val().length>128){
    debugger
    box.addClass("validatebox-invalid");
    opts.missingMessage = "输入字符长度过长"
    _442(opts.missingMessage);
    return false;
...
$.fn.validatebox.defaults={required:false,validType:null,validParams:null,delay:200,missingMessage:"必填",invalidMessage:null,tipPosition:"right",deltaX:0,novalidate:false,events:{focus:_429,blur:_42d,mouseenter:_431,mouseleave:_434,click:function(e){
var t=$(e.data.target);
if(!t.is(":focus")){
t.trigger("focus");
}
...
},message:"请输入正确的URL"},length:{validator:function(_455,_456){
var len=$.trim(_455).length;
return len>=_456[0]&&len<=_456[1];
},message:"请输入长度在 {0} 到 {1}之间"},remote:{validator:function(_457,_458){
var data={};
data[_458[1]]=_457;
...
ed.actions.resize(ed.target,cell.width()*0.8);
}
});
};
