<%@ Page Title="" Language="C#" MasterPageFile="~/common/Site.master" AutoEventWireup="true" Inherits="item_item_query" Codebehind="item_query.aspx.cs" %>
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="操作" ItemStyle-Width="150px" ItemStyle-CssClass=" gv-5icon"
                                ...
                                <ItemTemplate>
                                    ...
                                    <a style="display:none;" href="#" onclick="go_Status('<%#Eval("Item_Id") %>','<%#Eval("Status") %>')">
                                        <img src="../img/<%#Eval("Status").ToString()=="1"?"disable.png":"enable.png" %>" title= "<%#Eval("Status").ToString()=="1"?"停用":"启用"%>" />
                                    </a>
                                    <a style="display:none;" href="#" onclick="go_Propery('<%#Eval("Item_Id") %>')">
                                        <img src="../img/property.png" alt="" title="属性" />
                                    </a> 
                                    <a style="display:none;" href="#" onclick="go_Price('<%#Eval("Item_Id") %>')">
                                        <img src="../img/price.png" alt="" title="价格" />
                                    </a> 
                                    <a style="display:none;" href="#" onclick="go_Sku('<%#Eval("Item_Id") %>')">
                                        <img src="../img/sku.png" alt="" title="SKU" />
                                    </a> 
                                    <a style="display:none;" href="#" onclick="go_Pic('<%#Eval("Item_Id") %>')">
                                        <img src="../img/image.png" alt="" title="图片" />
                                    </a>
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
