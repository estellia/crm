...
public partial class item_item_price_adjust_query : PageBase
{
    ...
    #region 服务
    protected cPos.Admin.Service.AdjustmentOrderService OrderService
    {
        get
        {
    ...
    protected cPos.Admin.Service.ItemPriceTypeService PriceTypeService
    {
        get
        {
    ...
    protected cPos.Admin.Service.BillService BillService
    {
        get
        {
            return new cPos.Admin.Service.BillService();
        }
    }
    #endregion
    //查询条件
