<%@ Page Title="" Language="C#" MasterPageFile="~/common/Site.master" AutoEventWireup="true" Inherits="item_item_show" Codebehind="item_show.aspx.cs" %>
...
<asp:ListItem Text="否" Value="0" Selected="True"></asp:ListItem>
                     ...
                     <tr>
                        ...
                        <td>
                            <div class="box_r"></div>
                            <asp:DropDownList runat="server" ID="ifservice" Width="125px"><asp:ListItem Text="是" Value="1"></asp:ListItem>
<asp:ListItem Text="否" Value="0" Selected="True"></asp:ListItem>
</asp:DropDownList>
