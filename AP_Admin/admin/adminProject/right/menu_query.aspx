<%@ Page Title="" Language="C#" MasterPageFile="~/common/Site.master" AutoEventWireup="true" Inherits="right_menu_query" Codebehind="menu_query.aspx.cs" %>
...
<%--                        <asp:TemplateField ItemStyle-CssClass="gv-checkbox hidden" HeaderText="<input type='checkbox' id='chk_all'/>">
                        ...
                        <asp:TemplateField HeaderText="备注" ItemStyle-CssClass="gv-2icon" ItemStyle-Width="138px">
                            <ItemTemplate>
