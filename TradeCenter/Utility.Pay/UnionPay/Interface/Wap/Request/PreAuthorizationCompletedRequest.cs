...
namespace JIT.Utility.Pay.UnionPay.Interface.Wap.Request
{
    ...
    /// </remarks>
    /// </summary>
    public class PreAuthorizationCompletedRequest:BaseAPIRequest
    {
        #region 构造函数
        /// <summary>
        /// 构造函数 
        /// </summary>
        public PreAuthorizationCompletedRequest()
        {
            this.Application = "MPre.Req";
        }
        #endregion
