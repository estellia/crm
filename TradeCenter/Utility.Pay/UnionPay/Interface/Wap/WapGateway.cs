...
namespace JIT.Utility.Pay.UnionPay.Interface.Wap
{
    /// <summary>
    /// Wap支付的门户 
    /// </summary>
    public static class WapGateway
    {
        /// <summary>
        /// 支付接口的地址
        /// </summary>
        //static string API_URL = "http://58.246.136.11:8089/wapDetect/gateWay!gate.ac";
        //static string API_URL = "http://58.246.136.11:8006/wapDetect/gateWay!gate.ac";
        static string API_URL = "http://upwap.bypay.cn/gateWay/gate.html";
            ...
            where TResponse : BaseAPIResponse, new()
        {
            ...
            if (pRequest == null)
                ...
                var desKey = EncDecUtil.GetEncryptKey(pChannel.PacketEncryptKey);   //获取实际进行DES加密的密钥
                //采用Base64(RSA(加密密钥))计算出报文中的加密密钥
                var encryptedDesKey = EncDecUtil.Base64Encrypt(EncDecUtil.RSAEncrypt(pChannel.CertificateFilePath, pChannel.CertificateFilePassword, desKey));
            ...
            {
                string strResponse = wc.UploadString(WapGateway.API_URL, requestContent);
                Log.Loggers.Debug(new Log.DebugLogInfo() { Message = strResponse });
        ...
        {
            return WapGateway.CallAPI<PreOrderRequest, PreOrderResponse>(pChannel, pRequest);
        }
        ...
        {
            return WapGateway.CallAPI<QueryOrderRequest, QueryOrderResponse>(pChannel, pRequest);
        }
        ...
        ///// <remarks>
        ///// <para>商户平台 -> 支付平台</para>
        ///// <para>Note:消费撤销功能不能走接口来做，必须手工把要撤销或者退款的订单提交给支付接口方，由支付接口方来做</para>
        ///// </remarks>
        ///// </summary>
        ///// <param name="pChannel">调用支付接口的基本设置信息</param>
        ///// <param name="pRequest">交易撤销请求</param>
        ///// <returns></returns>
        //public static CancelTransactionResponse CancelTransaction(UnionPayChannel pChannel, CancelTransactionRequest pRequest)
        //{
        //    return WapGateway.CallAPI<CancelTransactionRequest, CancelTransactionResponse>(pChannel, pRequest);
        //}
        ...
        ///// </summary>
        ///// <param name="pChannel">调用支付接口的基本设置信息</param>
        ///// <param name="pRequest">退货请求</param>
        ///// <returns></returns>
        //public static ReturnOrderResponse ReturnOrder(UnionPayChannel pChannel, ReturnOrderRequest pRequest)
        //{
        //    return WapGateway.CallAPI<ReturnOrderRequest, ReturnOrderResponse>(pChannel, pRequest);
        //}
        ...
        ///// </summary>
        ///// <param name="pChannel">调用支付接口的基本设置信息</param>
        ///// <param name="pRequest">预授权完成请求</param>
        ///// <returns></returns>
        //public static PreAuthorizationCompletedResponse PreAuthorizationCompleted(UnionPayChannel pChannel, PreAuthorizationCompletedRequest pRequest)
        //{
        //    return WapGateway.CallAPI<PreAuthorizationCompletedRequest, PreAuthorizationCompletedResponse>(pChannel, pRequest);
        //}
