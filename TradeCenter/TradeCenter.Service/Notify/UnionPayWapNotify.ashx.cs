...
{
    /// <summary>
    /// UnionPayWapNotify 的摘要说明
    /// </summary>
    public class UnionPayWapNotify : PaySuccessBaseNotify
    {
        public override bool Process(PayChannelEntity pChannel, HttpContext context, out Entity.AppOrderEntity entity)
        {
            ...
            using (StreamReader sr = new StreamReader(context.Request.InputStream))
            {
                try
                {
                    ...
                    var req = WapGateway.ParseTransactionNotificationRequest(UnionWapChannel.DecryptCertificateFilePath, strReq);
