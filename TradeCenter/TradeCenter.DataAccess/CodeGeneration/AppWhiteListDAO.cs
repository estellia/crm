...
namespace JIT.TradeCenter.DataAccess
{
    ...
    public partial class AppWhiteListDAO : BaseTradeCenerDAO, ICRUDable<AppWhiteListEntity>, IQueryable<AppWhiteListEntity>
    {
        ...
        /// 构造函数 
        /// </summary>
        public AppWhiteListDAO(BasicUserInfo pUserInfo)
            : base(pUserInfo)
        {
        }
        #endregion
        ...
        public void Create(AppWhiteListEntity pEntity, IDbTransaction pTran)
        {
            ...
            strSql.Append("insert into [AppWhiteList](");
            strSql.Append("[IPAddress],[AppID],[Regex],[CreateBy],[CreateTime],[LastUpdateBy],[LastUpdateTime],[IsDelete],[AppWhiteListID])");
            strSql.Append(" values (");
            strSql.Append("@IPAddress,@AppID,@Regex,@CreateBy,@CreateTime,@LastUpdateBy,@LastUpdateTime,@IsDelete,@AppWhiteListID)");

            Guid? pkGuid;
            if (pEntity.AppWhiteListID == null)
                pkGuid = Guid.NewGuid();
            else
                pkGuid = pEntity.AppWhiteListID;

            SqlParameter[] parameters = 
            {
					new SqlParameter("@IPAddress",SqlDbType.NVarChar),
					new SqlParameter("@AppID",SqlDbType.NVarChar),
					new SqlParameter("@Regex",SqlDbType.NVarChar),
					new SqlParameter("@CreateBy",SqlDbType.NVarChar),
					new SqlParameter("@CreateTime",SqlDbType.DateTime),
					new SqlParameter("@LastUpdateBy",SqlDbType.NVarChar),
					new SqlParameter("@LastUpdateTime",SqlDbType.DateTime),
					new SqlParameter("@IsDelete",SqlDbType.Int),
					new SqlParameter("@AppWhiteListID",SqlDbType.UniqueIdentifier)
            };
            parameters[0].Value = pEntity.IPAddress;
            parameters[1].Value = pEntity.AppID;
            parameters[2].Value = pEntity.Regex;
        ...
        public AppWhiteListEntity GetByID(object pID)
        {
            ...
            sql.AppendFormat("select * from [AppWhiteList] where AppWhiteListID='{0}' and IsDelete=0 ", id.ToString());
            //读取数据
            AppWhiteListEntity m = null;
        ...
        public AppWhiteListEntity[] GetAll()
        {
            //组织SQL
            StringBuilder sql = new StringBuilder();
            sql.AppendFormat("select * from [AppWhiteList] where isdelete=0");
            //读取数据
        ...
        /// <param name="pEntity">实体实例</param>
        /// <param name="pTran">事务实例,可为null,如果为null,则不使用事务来更新</param>
        public void Update(AppWhiteListEntity pEntity, IDbTransaction pTran, bool pIsUpdateNullField)
        {
            //参数校验
            if (pEntity == null)
                throw new ArgumentNullException("pEntity");
            if (!pEntity.AppWhiteListID.HasValue)
            {
            ...
            //组织参数化SQL
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update [AppWhiteList] set ");
            ...
            if (pIsUpdateNullField || pEntity.Regex != null)
                strSql.Append("[Regex]=@Regex,");
            if (pIsUpdateNullField || pEntity.LastUpdateBy != null)
                strSql.Append("[LastUpdateBy]=@LastUpdateBy,");
            if (pIsUpdateNullField || pEntity.LastUpdateTime != null)
                strSql.Append("[LastUpdateTime]=@LastUpdateTime");
            strSql.Append(" where AppWhiteListID=@AppWhiteListID ");
            SqlParameter[] parameters = 
            {
					new SqlParameter("@IPAddress",SqlDbType.NVarChar),
					new SqlParameter("@AppID",SqlDbType.NVarChar),
            ...
            parameters[5].Value = pEntity.AppWhiteListID;
        ...
        public void Delete(AppWhiteListEntity pEntity, IDbTransaction pTran)
        {
            ...
            //执行 
            this.Delete(pEntity.AppWhiteListID.Value, pTran);
        }
        ...
        public void Delete(object pID, IDbTransaction pTran)
        {
            ...
            //组织参数化SQL
            StringBuilder sql = new StringBuilder();
            sql.AppendLine("update [AppWhiteList] set LastUpdateTime=@LastUpdateTime,LastUpdateBy=@LastUpdateBy,IsDelete=1 where AppWhiteListID=@AppWhiteListID;");
            ...
            { 
                ...
                new SqlParameter{ParameterName="@AppWhiteListID",SqlDbType=SqlDbType.UniqueIdentifier,Value=pID}
            };
            //执行语句
            int result = 0;
            if (pTran != null)
        ...
        public void Delete(AppWhiteListEntity[] pEntities, IDbTransaction pTran)
        {
            ...
            for (int i = 0; i < pEntities.Length; i++)
            {
                ...
                entityIDs[i] = pEntity.AppWhiteListID;
            }
        ...
        public void Delete(object[] pIDs, IDbTransaction pTran)
        {
            ...
            StringBuilder sql = new StringBuilder();
            sql.AppendLine("update [AppWhiteList] set LastUpdateTime='" + DateTime.Now.ToString() + "',LastUpdateBy=" + CurrentUserInfo.UserID + ",IsDelete=1 where AppWhiteListID in (" + primaryKeys.ToString().Substring(0, primaryKeys.ToString().Length - 1) + ");");
            //执行语句
            int result = 0;
            if (pTran == null)
        ...
        public PagedQueryResult<AppWhiteListEntity> PagedQuery(IWhereCondition[] pWhereConditions, OrderBy[] pOrderBys, int pPageSize, int pCurrentPageIndex)
        {
            ...
            {
                pagedSql.AppendFormat(" [AppWhiteListID] desc"); //默认为主键值倒序
            }
            pagedSql.AppendFormat(") as ___rn,* from [AppWhiteList] where isdelete=0 ");
            //总记录数SQL
            totalCountSql.AppendFormat("select count(1) from [AppWhiteList] where isdelete=0 ");
            //过滤条件
            if (pWhereConditions != null)
            {
                foreach (var item in pWhereConditions)
            ...
            //执行语句并返回结果
            PagedQueryResult<AppWhiteListEntity> result = new PagedQueryResult<AppWhiteListEntity>();
            List<AppWhiteListEntity> list = new List<AppWhiteListEntity>();
        ...
        /// </summary>
        /// <returns></returns>
        protected IWhereCondition[] GetWhereConditionByEntity(AppWhiteListEntity pQueryEntity)
        {
            //获取非空属性数量
            List<EqualsCondition> lstWhereCondition = new List<EqualsCondition>();
            if (pQueryEntity.AppWhiteListID != null)
                lstWhereCondition.Add(new EqualsCondition() { FieldName = "AppWhiteListID", Value = pQueryEntity.AppWhiteListID });
            ...
            if (pQueryEntity.Regex != null)
                lstWhereCondition.Add(new EqualsCondition() { FieldName = "Regex", Value = pQueryEntity.Regex });
        ...
        protected void Load(SqlDataReader pReader, out AppWhiteListEntity pInstance)
        {
            //将所有的数据从SqlDataReader中读取到Entity中
            pInstance = new AppWhiteListEntity();
            pInstance.PersistenceHandle = new PersistenceHandle();
            pInstance.PersistenceHandle.Load();

            if (pReader["AppWhiteListID"] != DBNull.Value)
            {
                pInstance.AppWhiteListID = (Guid)pReader["AppWhiteListID"];
            }
            ...
            if (pReader["Regex"] != DBNull.Value)
            {
                pInstance.Regex = Convert.ToString(pReader["Regex"]);
            }
