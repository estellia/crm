	...
	public class FeedbackService : IDisposable
	{
        ...
        public FeedbackService(string host, int port, byte[] p12FileBytes)
        {
 	    ...
 	    //      So MachineKeySet should be used instead.
            certificate = new X509Certificate2(p12FileBytes, string.Empty, X509KeyStorageFlags.MachineKeySet | X509KeyStorageFlags.PersistKeySet | X509KeyStorageFlags.Exportable);
            ConnectAttempts = 3;
            ReconnectDelay = 10000;
        }
