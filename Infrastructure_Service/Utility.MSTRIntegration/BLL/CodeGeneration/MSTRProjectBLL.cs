...
{   
    /// <summary>
    /// 业务处理： MSTR的项目,这里的信息主要用于创建MSTR的Session，同时项目的信息也用于在集成时生成访问MSTR报表的Url 
    /// </summary>
    public partial class MSTRProjectBLL
    {
        private ReportUserInfo CurrentUserInfo;
        private MSTRProjectDAO _currentDAO;
        #region 构造函数
        /// <summary>
        /// 构造函数 
        /// </summary>
        public MSTRProjectBLL(ReportUserInfo pUserInfo,ISQLHelper pSQLHelper)
        {
            this.CurrentUserInfo = pUserInfo;
            this._currentDAO = new MSTRProjectDAO(pUserInfo,pSQLHelper);
        }
        #endregion
        #region ICRUDable 成员
        /// <summary>
