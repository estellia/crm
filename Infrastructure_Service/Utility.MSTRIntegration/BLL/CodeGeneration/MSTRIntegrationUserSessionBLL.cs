...
{   
    /// <summary>
    /// 业务处理： 租户平台的用户登录网站后,插入一条这样的记录.MSTR的认证模块根据记录中的信息来创建/重新加载 MSTR的Session. 
    /// </summary>
    public partial class MSTRIntegrationUserSessionBLL
    {
        private ReportUserInfo CurrentUserInfo;
        private MSTRIntegrationUserSessionDAO _currentDAO;
        #region 构造函数
        /// <summary>
        /// 构造函数 
        /// </summary>
