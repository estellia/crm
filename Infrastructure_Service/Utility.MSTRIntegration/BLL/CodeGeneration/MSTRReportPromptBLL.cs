...
{   
    /// <summary>
    /// 业务处理： MSTR报表所关联的Prompt 
    /// </summary>
    public partial class MSTRReportPromptBLL
    {
        private ReportUserInfo CurrentUserInfo;
        private MSTRReportPromptDAO _currentDAO;
        #region 构造函数
        /// <summary>
        /// 构造函数 
        /// </summary>
        public MSTRReportPromptBLL(ReportUserInfo pUserInfo,ISQLHelper pSQLHelper)
        {
            this.CurrentUserInfo = pUserInfo;
            this._currentDAO = new MSTRReportPromptDAO(pUserInfo,pSQLHelper);
        }
        #endregion
        #region ICRUDable 成员
        /// <summary>
