...
namespace JIT.Utility.MobileDeviceManagement.BLL
{   
    /// <summary>
    /// 业务处理：  
    /// </summary>
    public partial class MobileLogRecordBLL
    {
        private MobileDeviceManagementUserInfo CurrentUserInfo;
        private MobileLogRecordDAO _currentDAO;
        #region 构造函数
        /// <summary>
        /// 构造函数 
        /// </summary>
        public MobileLogRecordBLL(MobileDeviceManagementUserInfo pUserInfo, ISQLHelper pSQlHelper)
        {
            this._currentDAO = new MobileLogRecordDAO(pUserInfo, pSQlHelper);
        }
        #endregion
        #region ICRUDable 成员
        /// <summary>
