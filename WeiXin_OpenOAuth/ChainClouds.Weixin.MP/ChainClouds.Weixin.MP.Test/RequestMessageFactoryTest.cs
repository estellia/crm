...
namespace ChainClouds.Weixin.MP.Test
{
    [TestClass]
...
<Description><![CDATA[ChainClouds.Weixin.MP SDK公众平台官网链接]]></Description>
...
<xml>
  ...
  <EventKey><![CDATA[http://weixin.chainclouds.com]]></EventKey>
</xml>
";
    ...
    <AroundBeacons>
        ...
        public void GetRequestEntityTest()
        {
...

            {
                ...
                Assert.AreEqual("ChainClouds.Weixin.MP SDK公众平台官网链接", result.Description);
                Assert.AreEqual("http://weixin.chainclouds.com", result.Url);
            }
...

            {
                ...
                Assert.AreEqual("http://weixin.chainclouds.com", result.EventKey);
            }
