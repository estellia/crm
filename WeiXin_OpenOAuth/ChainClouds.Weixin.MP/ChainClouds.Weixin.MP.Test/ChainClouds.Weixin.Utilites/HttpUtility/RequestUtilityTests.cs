...
using ChainClouds.Weixin.MP;
using ChainClouds.Weixin.MP.AdvancedAPIs.Media;

namespace ChainClouds.Weixin.HttpUtility.Tests
{
    [TestClass]
    public class RequestUtilityTests
    {
        ...
        public void HttpPostTest()
        {
            ...
            //随便找一个存在的测试图片
            var file = "..\\..\\..\\..\\ChainClouds.Weixin.MP.Sample\\ChainClouds.Weixin.MP.Sample\\Images\\qrcode.jpg";
