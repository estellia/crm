...
namespace ChainClouds.Weixin.MP.Test.Entities.Response
{
    [TestClass]
    public class ResponseMessageBaseTest
    {
        ...
        public void CreateFromRequestMessageTest()
        {
            ...
            Assert.AreEqual("ChainClouds", responseMessage.FromUserName);
...
<xml>
  ...
  <Music>
    ...
    <MusicUrl><![CDATA[http://weixin.chainclouds.com/Content/music1.mp3]]></MusicUrl>
  ...
  <FuncFlag>0</FuncFlag>
                ...
                Assert.AreEqual("http://weixin.chainclouds.com/Content/music1.mp3", strongResponseMessage.Music.MusicUrl);
...
<xml>
  ...
  <Articles>
    <item>
      ...
      <PicUrl><![CDATA[http://weixin.chainclouds.com/Images/qrcode.jpg]]></PicUrl>
      <Url><![CDATA[http://weixin.chainclouds.com]]></Url>
    </item>
  </Articles>
  <FuncFlag>0</FuncFlag>
</xml>";
