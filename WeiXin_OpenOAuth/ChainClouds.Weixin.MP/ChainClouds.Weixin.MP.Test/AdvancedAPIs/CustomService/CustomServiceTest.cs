...
using ChainClouds.Weixin.MP.AdvancedAPIs.CustomService;
...
namespace ChainClouds.Weixin.MP.Test.AdvancedAPIs
{
    ...
    public class CustomServiceTest : CommonApiTest
    {
        ...
        {
            var accessToken = AccessTokenContainer.GetAccessToken(_appId);
            var result = CustomServiceApi.AddCustom(accessToken, "zcc@ChainCloudsRobot", "zcc", _custonPassWord);
        ...
        public void UploadCustomHeadimgCustom()
        {
            ...
            var accessToken = AccessTokenContainer.GetAccessToken(_appId);
            var result = CustomServiceApi.UploadCustomHeadimg(accessToken, "zcc@ChainCloudsRobot", file);
            Assert.AreEqual(result.errcode, ReturnCode.请求成功);
        }
        ...
        {
            var accessToken = AccessTokenContainer.GetAccessToken(_appId);
            var result = CustomServiceApi.DeleteCustom(accessToken, "zcc@ChainCloudsRobot");
            Assert.AreEqual(result.errcode, ReturnCode.请求成功);
        }
        ...
        {
            var accessToken = AccessTokenContainer.GetAccessToken(_appId);
            var result = CustomServiceApi.CreateSession(accessToken, _testOpenId, "zcc@ChainCloudsRobot");
            Assert.AreEqual(result.errcode, ReturnCode.请求成功);
        }
        ...
        {
            var accessToken = AccessTokenContainer.GetAccessToken(_appId);
            var result = CustomServiceApi.CloseSession(accessToken, _testOpenId, "zcc@ChainCloudsRobot");
            Assert.AreEqual(result.errcode, ReturnCode.请求成功);
        }
