...
namespace ChainClouds.Weixin.MP.Web.CommonService.Utilities
{
    public static class Server
    {
        ...
        public static HttpContext HttpContext
        {
            get
            {
                ...
                if (context == null)
                {
                    HttpRequest request = new HttpRequest("Default.aspx", "http://open.chainclouds.com/default.aspx", null);
