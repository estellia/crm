...
using ChainClouds.Weixin.MP.Agent;
...
namespace ChainClouds.Weixin.MP.Web.CommonService.CustomMessageHandler
{
    /// <summary>
    /// 自定义MessageHandler
...
#else
        //下面的Url和Token可以用其他平台的消息，或者到www.chainclouds.com注册微信用户，将自动在“微信营销工具”下得到
        private string agentUrl = WebConfigurationManager.AppSettings["WeixinAgentUrl"];//这里使用了www.chainclouds.com微信自动托管平台
        private string agentToken = WebConfigurationManager.AppSettings["WeixinAgentToken"];//Token
        private string wiweihiKey = WebConfigurationManager.AppSettings["WeixinAgentChaincloudsKey"];//ChaincloudsKey专门用于对接www.chainclouds.com平台，获取方式见：http://www.chainclouds.com/ApiDocuments/Item/25#51
#endif
...
测试完成后，您可以登陆公众号后台取消授权。",
        ...
        public override IResponseMessageBase OnImageRequest(RequestMessageImage requestMessage)
        {
            ...
            responseMessage.Articles.Add(new Article()
            {
                ...
                Url = requestMessage.PicUrl//"http://open.chainclouds.com"
            });
            //responseMessage.Articles.Add(new Article()
            //{
            //    Title = "第二条",
        ...
        public override IResponseMessageBase OnVoiceRequest(RequestMessageVoice requestMessage)
        {
            ...
            responseMessage.Music.MusicUrl = "http://open.chainclouds.com/Media/GetVoice?mediaId=" + requestMessage.MediaId;
            responseMessage.Music.HQMusicUrl = "http://open.chainclouds.com/Media/GetVoice?mediaId=" + requestMessage.MediaId;
