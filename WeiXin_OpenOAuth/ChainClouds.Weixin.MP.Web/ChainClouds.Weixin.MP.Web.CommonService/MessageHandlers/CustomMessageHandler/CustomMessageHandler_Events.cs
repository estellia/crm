...
namespace ChainClouds.Weixin.MP.Web.CommonService.CustomMessageHandler
{
    ...
    public partial class CustomMessageHandler
    {
        ...
        {
            //获取ChainClouds.Weixin.MP.dll版本信息
            var fileVersionInfo = FileVersionInfo.GetVersionInfo(HttpContext.Current.Server.MapPath("~/bin/ChainClouds.Weixin.MP.dll"));
            var version = string.Format("{0}.{1}", fileVersionInfo.FileMajorPart, fileVersionInfo.FileMinorPart);
            return string.Format(
@"欢迎关注【连锁掌柜微信公众平台】，当前运行版本：v{0}。
您可以发送【文字】【位置】【图片】【语音】等不同类型的信息，查看不同格式的回复。

您也可以直接点击菜单查看各种类型的回复。
还可以点击菜单体验微信支付。

官方地址：http://www.chainclouds.com
                ...
                case "SubClickRoot_News":
                    {
                        ...
                        strongResponseMessage.Articles.Add(new Article()
                        {
                            ...
                            PicUrl = "http://open.chainclouds.com/Images/qrcode.jpg",
                ...
                case "SubClickRoot_Music":
                    {
                        ...
                        strongResponseMessage.Music.MusicUrl = "http://open.chainclouds.com/Content/music1.mp3";
                        strongResponseMessage.Music.HQMusicUrl = "http://open.chainclouds.com/Content/music1.mp3";
                ...
                case "OAuth"://OAuth授权测试
                    {
                        ...
                        {
                            Title = "OAuth2.0测试",
                            Description = "点击【查看全文】进入授权页面。\r\n注意：此页面仅供测试（是专门的一个临时测试账号的授权，并非官方账号，所以如果授权后出现错误页面数正常情况），测试号随时可能过期。请部署到服务器上，并使用自己的appid和secret。",
                            Url = "http://open.chainclouds.com/oauth2",
                            PicUrl = "http://open.chainclouds.com/Images/qrcode.jpg"
                        });
                        reponseMessage = strongResponseMessage;
                    }
