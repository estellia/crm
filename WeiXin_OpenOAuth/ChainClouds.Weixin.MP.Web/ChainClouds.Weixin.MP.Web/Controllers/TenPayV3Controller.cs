...
using ChainClouds.Weixin.BrowserUtility;
using ChainClouds.Weixin.MP.AdvancedAPIs;
using ChainClouds.Weixin.MP.AdvancedAPIs.OAuth;
using ChainClouds.Weixin.MP.Web.Models;
using ChainClouds.Weixin.MP.TenPayLibV3;
using ZXing;
using ZXing.Common;
...
namespace ChainClouds.Weixin.MP.Web.Controllers
{
    ...
    public class TenPayV3Controller : Controller
    {
        ...
        {
            var returnUrl = string.Format("http://open.chainclouds.com/TenPayV3/JsApi");
   ...
   <return_msg><![CDATA[{1}]]></return_msg>
        ...
        public ActionResult ProductPayCode(int productId, int hc)
        {
            ...
            var url = string.Format("http://open.chainclouds.com/TenPayV3?productId={0}&hc={1}&t={2}", productId,
