...
using ChainClouds.Weixin.MP.Web.CommonService.QyMessageHandlers;
...
namespace ChainClouds.Weixin.MP.Web.Controllers
{
    ...
    public class ThirdPartyAuthController : Controller
    {
        ...
        /// <summary>
        /// 微信后台验证地址（使用Get），微信企业后台应用的“修改配置”的Url填写如：http://weixin.chainclouds.com/ThirdPartyAuth
        /// </summary>
        [HttpGet]
        [ActionName("Index")]
        ...
        /// <summary>
        /// 微信后台验证地址（使用Post），微信企业后台应用的“修改配置”的Url填写如：http://weixin.chainclouds.com/ThirdPartyAuth
        /// </summary>
        [HttpPost]
        [ActionName("Index")]
