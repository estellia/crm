...
namespace ChainClouds.Weixin.MP.Web.Controllers
{
    ...
    //using ChainClouds.Weixin.MP.Web.Service;
    //using ChainClouds.Weixin.MP.Web.CustomerMessageHandler;
    using ChainClouds.Weixin.MP.Web.CommonService;
    ...
    public partial class WeixinController : Controller
    {
        ...
        /// <summary>
        /// 微信后台验证地址（使用Get），微信后台的“接口配置信息”的Url填写如：http://open.chainclouds.com/weixin
        /// </summary>
        [HttpGet]
        [ActionName("Index")]
        ...
        /// v0.8之后的版本可以结合ChainClouds.Weixin.MP.MvcExtension扩展包，使用WeixinResult，见MiniPost方法。
        /// </summary>
        [HttpPost]
        [ActionName("Index")]
         ...
         * 因此如果需要深入了解ChainClouds.Weixin.MP内部处理消息的机制，可以查看WeixinController_OldPost.cs中的OldPost方法。
