...
namespace ChainClouds.Weixin.MP.Web.Controllers
{
    public class BaseController : Controller
    {
        ...
        {
            var weixinFileVersionInfo = FileVersionInfo.GetVersionInfo(Server.MapPath("~/bin/ChainClouds.Weixin.dll"));
            var mpFileVersionInfo = FileVersionInfo.GetVersionInfo(Server.MapPath("~/bin/ChainClouds.Weixin.MP.dll"));
            var extensionFileVersionInfo = FileVersionInfo.GetVersionInfo(Server.MapPath("~/bin/ChainClouds.Weixin.MP.MvcExtension.dll"));
