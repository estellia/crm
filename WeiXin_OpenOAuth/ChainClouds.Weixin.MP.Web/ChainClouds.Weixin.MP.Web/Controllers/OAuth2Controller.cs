/*----------------------------------------------------------------
    ...
    文件功能描述：提供OAuth2.0授权测试（关注微信公众号：连锁掌柜小助手，点击菜单【功能体验】 【OAuth2.0授权测试】即可体验）
...
using ChainClouds.Weixin.MP.AdvancedAPIs.OAuth;
...
namespace ChainClouds.Weixin.MP.Web.Controllers
{
    public class OAuth2Controller : Controller
    {
        ...
        {
            //此页面引导用户点击授权
            ViewData["UrlUserInfo"] = OAuthApi.GetAuthorizeUrl(appId, "http://open.chainclouds.com/oauth2/UserInfoCallback", "ZmindBob", OAuthScope.snsapi_userinfo);
            ViewData["UrlBase"] = OAuthApi.GetAuthorizeUrl(appId, "http://open.chainclouds.com/oauth2/BaseCallback", "ZmindBob", OAuthScope.snsapi_base);
            return View();
        }
