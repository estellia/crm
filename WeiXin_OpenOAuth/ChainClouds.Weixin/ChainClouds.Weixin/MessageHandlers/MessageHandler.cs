...
namespace ChainClouds.Weixin.MessageHandlers
{
    /// <summary>
    /// 微信请求的集中处理方法
    /// 此方法中所有过程，都基于ChainClouds.Weixin的基础功能，只为简化代码而设。
    /// </summary>
        ...
        where TResponse : IResponseMessageBase
    {
        ...
        /// 如果是ChainClouds.Weixin.QY，则应当和ResponseDocument一致；如果是ChainClouds.Weixin.QY，则应当在ResponseDocument基础上进行加密
        /// </summary>
        ...
        public MessageHandler(RequestMessageBase requestMessageBase, int maxRecordCount = 0, object postData = null)
        {
            ...
            //此方法不执行任何方法，提供给具体的类库进行测试使用，例如ChainClouds.Weixin.QY
        }
