...
namespace ChainClouds.Weixin.Open.CommonAPIs
{
    ...
    public static class CommonJsonSend
    {
        ...
        {
            return ChainClouds.Weixin.CommonAPIs.CommonJsonSend.Send(accessToken, urlFormat, data, sendType, timeOut, checkValidationResult, jsonSetting);
        }
