...
using ChainClouds.Weixin.QY.Helpers;
using Tencent;

namespace ChainClouds.Weixin.QY.MessageHandlers
{
        ...
        where TC : class ,IMessageContext<IRequestMessageBase, IResponseMessageBase>, new()
    {
        ...
        /// 这里是ChainClouds.Weixin.QY，应当在ResponseDocument基础上进行加密（每次获取重新加密，所以结果会不同）
        /// </summary>
