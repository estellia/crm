...
{
    internal class T_User_RoleCMD
    {
        internal void Create(T_User_RoleEntity dbEntity)
        {
        ...
        internal void Update(T_User_RoleEntity dbEntity)
        {
            using (var conn = new SqlConnection(ConnectionString.XgxInsert))
            {
                dbEntity.modify_time = System.DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss.fff");
        ...
        internal void Delete(T_User_RoleEntity dbEntity)
        {
            using (var conn = new SqlConnection(ConnectionString.XgxInsert))
            {
                conn.Open();
