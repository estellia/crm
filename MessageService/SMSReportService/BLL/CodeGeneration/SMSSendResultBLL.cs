...
using JIT.SMSReportService.DataAccess;
using JIT.SMSReportService.Entity;

namespace JIT.SMSReportService.BLL
{   
    /// <summary>
    /// 业务处理：  
    /// </summary>
    public partial class SMSSendResultBLL
    {
        private BasicUserInfo CurrentUserInfo;
        private SMSSendResultDAO _currentDAO;
        #region 构造函数
        /// <summary>
        /// 构造函数 
        /// </summary>
        public SMSSendResultBLL(BasicUserInfo pUserInfo)
        {
            this._currentDAO = new SMSSendResultDAO(pUserInfo);
        }
        #endregion
        #region ICRUDable 成员
        /// <summary>
