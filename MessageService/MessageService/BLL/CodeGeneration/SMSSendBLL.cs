...
namespace JIT.MessageService.BLL
{   
    /// <summary>
    /// 业务处理：  
    /// </summary>
    public partial class SMSSendBLL
    {
        private BasicUserInfo CurrentUserInfo;
        private SMSSendDAO _currentDAO;
        #region 构造函数
        /// <summary>
        /// 构造函数 
        /// </summary>
        public SMSSendBLL(BasicUserInfo pUserInfo)
        {
            this._currentDAO = new SMSSendDAO(pUserInfo);
        }
        #endregion
        #region ICRUDable 成员
        /// <summary>
